  ...
  return (
    <div>
      <div className="mb-10 flex flex-col items-center gap-5 sm:flex-row sm:justify-between">
        ...
        <div className="flex items-center gap-2 rounded-full border border-line px-4 py-2 text-sm font-semibold text-ink">
                ...
                <article className="card card-hover group flex h-full flex-col overflow-hidden">
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <div className="mt-auto flex items-center justify-between pt-4">
                      ...
                      <button
                        onClick={() => setBag((b) => ({ ...b, [p.id]: (b[p.id] ?? 0) + 1 }))}
                        className={cn(
      ...
      <p className="mt-10 text-center text-xs text-faint">
        Products shown are illustrative placeholders. Checkout is not enabled in this demo.
      </p>
    </div>
  );
}
